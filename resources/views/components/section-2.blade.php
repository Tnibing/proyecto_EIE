<div class="overflow-hidden bg-gradient-to-r from-blue-50 to-gray-50 py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div class="lg:pr-8 lg:pt-4 flex flex-col justify-between">
            ...
            <img src="./alvan-nee-T-0EW-SEbsE-unsplash.jpg" alt="Product screenshot" class="w-full h-full object-cover rounded-xl shadow-xl ring-1 ring-gray-400/10" width="2432" height="1442">
        </div>
    </div>
</div>
